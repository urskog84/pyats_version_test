...
class CopyPatterns():
    def __init__(self):
        ...
        self.copy_error_message = r'fail|timed out|Timed out|Error opening|Login incorrect|denied|Problem|NOT|Invalid|No memory|Failed|mismatch|Bad|bogus|lose|abort|Not |too big|exceeds|detected|[Nn]o route to host|image is not allowed|Could not resolve'
